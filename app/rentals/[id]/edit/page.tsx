...
const EditRentalPage = async ({ params }: { params: { id: string } }) => {
  ...
  const nonParse: string = property.amenities;
  const updatePropertyImage = updatePropertyImageAction.bind(null, {
    id: property.id,
  });
  const updateProperty = updatePropertyAction.bind(null, { id: property.id });
  return (
    <section>
